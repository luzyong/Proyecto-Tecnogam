...
app.post('/work', (req, res) => {
  const sql = 'INSERT INTO horno SET ?';
...
*/
//Modificaciones
app.put('/actualizacliente', (req, res) => {
...
app.delete('/eliminarauto', (req, res) => {
