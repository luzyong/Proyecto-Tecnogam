...
def read():
    ...
    valores = [SH_TempZ1.Value,SH_TempZ1.Value,SH_TempZ2.Value,SH_TempCHMY_1.Value,SH_TempCHMY_2.Value,SH_SP_TempZ1.Value,SH_SP_TempZ2.Value,SH_SP_TempCHMYZ1.Value,SH_SP_TempCHMYZ2.Value,SH_Lim_TempZ1.Value,SH_Lim_TempZ2.Value,SH_Num_Lote_Actual.Value,SH_Tipo_Material_Actual.Value,SH_Cant_Material_Actual.Value,SH_PB_enc_Extractor.Value,SH_PB_enc_Bomba.Value,SH_PB_enc_Turbo1.Value,SH_PB_enc_Turbo2.Value,SH_PB_enc_Quemador.Value,SH_PB_Abrir_Puerta.Value,SH_PB_apag_Extractor.Value,SH_PB_apag_Bomba.Value,SH_PB_apag_Turbo1.Value,SH_PB_apag_Turbo2.Value,SH_PB_apag_Quemador.Value,SH_PB_Cerrar_Puerta.Value,SH_Falla_Motor.Value,SH_Falla_Temperatura.Value,SH_Falla_Quemador.Value]     
         
    return valores 

def write(state):
    SH_Luces = comm.Write('SH_Luces',state)
    if SH_Luces.Status == 'Success':
        return 1
    else:
        return 0
