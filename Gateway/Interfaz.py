...
class ventanas():
    def __init__(self,master):
        ...
        self.lucesON = Button(self.paquete4,text='TURN ON LIGTHS',bg='#3b444b',fg='white',relief=RAISED)
        self.lucesON.pack(side=LEFT, expand=YES, pady=6)
        self.lucesOFF = Button(self.paquete4,text='TURN OFF LIGTHS',bg='#3b444b',fg='white',relief=RAISED)
